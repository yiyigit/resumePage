export const resumeContent = {
  ...
  location: "Seattle",
  selfIntro:
    "Passionate scuba diver, thriving technology implementer. I enjoy team collaboration and bringing out the collective intelligence.",
  ...
  projects: [
    {
      title:
        "Movie Search, Full Stack Web (React, Express.js, Node.js, Webpack, Jest)",
      details: [
        "Delivered a single-page website for movie search, recommendation, commenting",
        "Designed responsive front-end interface in React",
        "Implemented server using Express.js on Node.js to connect to MongoDB",
        "Completed A/B testing by Google Analytics to refine the UI",
        "Optimized website load time from 5 seconds to 1 second by Pagination",
      ],
    },
  ],
  educations: [
    {
      ...
      date: "Sept 2019 - expected May 2021",
